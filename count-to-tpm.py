...
parser = argparse.ArgumentParser(
    prog="count-to-tpm.py",
    formatter_class=argparse.RawDescriptionHelpFormatter,
    description=textwrap.dedent('''
    ************************************************************************

    Script for generating TPM values from an htseq-generated counts table
...
parser.add_argument('-len', type=str, help="read length", default="150")
